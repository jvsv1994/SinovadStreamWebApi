...
public partial class ApplicationDbContext : IdentityDbContext<User, Role, int, IdentityUserClaim<int>, UserRole, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        new Menu { Id = 9, ParentId = 3, SortOrder = 1, Title = "Peliculas", Path = "/movie-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-film", Enabled = true },
        new Menu { Id = 10, ParentId = 3, SortOrder = 2, Title = "Series", Path = "/tvserie-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-tv", Enabled = true },
        new Menu { Id = 11, ParentId = 3, SortOrder = 3, Title = "Generos", Path = "/genre-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-list-check", Enabled = true },
        new Menu { Id = 12, ParentId = 3, SortOrder = 4, Title = "Roles", Path = "/role-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-list-check", Enabled = true },
        new Menu { Id = 13, ParentId = 3, SortOrder = 5, Title = "Usuarios", Path = "/user-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-user", Enabled = true },
        new Menu { Id = 14, ParentId = 3, SortOrder = 6, Title = "Menu", Path = "/menu-list", IconTypeCatalogId = (int)CatalogEnum.IconType, IconTypeCatalogDetailId = (int)IconType.FontAwesome, IconClass = "fa-solid fa-list-check", Enabled = true });
