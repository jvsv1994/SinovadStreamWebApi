...
namespace SinovadDemo.Persistence.Migrations
{
    ...
    [Migration("20230921233655_210920239")]
    partial class _210920239
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Generic.Core.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("28478a69-eb23-498f-b661-48f807ef4051"),
                            ParentId = 0,
                            SortOrder = 1,
                            Title = "General"
                        },
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("727bb71d-ad89-4662-8688-54737ef68f9a"),
                            ParentId = 0,
                            SortOrder = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Enabled = true,
                            Guid = new Guid("af6949e3-918b-4676-a939-baa1c2eb0fc0"),
                        ...
                        new
                        {
                            Id = 4,
                            Enabled = true,
                            Guid = new Guid("56dde2be-afa0-407d-a1e4-cdf012982581"),
                        ...
                        new
                        {
                            Id = 5,
                            Enabled = true,
                            Guid = new Guid("a16480a6-750c-4084-a243-cfbdb588ddda"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 6,
                            Enabled = true,
                            Guid = new Guid("1b0941ad-d2cb-4942-b0de-97399cb52269"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 7,
                            Enabled = true,
                            Guid = new Guid("a7ceee7a-44c6-47d8-911c-2486ec90f6d2"),
                        ...
                        new
                        {
                            Id = 8,
                            Enabled = true,
                            Guid = new Guid("071c8cf0-aa64-4699-bef7-5c0240086b08"),
                        ...
                        new
                        {
                            Id = 9,
                            Enabled = true,
                            Guid = new Guid("6a9c2a6d-5532-4a48-8b8e-f4f6e8aba056"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 2,
            ...
            modelBuilder.Entity("Generic.Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("3bd5783f-b0e1-4482-be21-bf5a0a812432"),
                        ...
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("3d7441c8-56f7-4e95-b26f-6fa8176f3a78"),
