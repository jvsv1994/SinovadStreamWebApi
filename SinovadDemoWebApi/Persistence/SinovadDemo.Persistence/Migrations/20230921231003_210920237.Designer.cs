...
namespace SinovadDemo.Persistence.Migrations
{
    ...
    [Migration("20230921231003_210920237")]
    partial class _210920237
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Generic.Core.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("83978f68-10f2-4b49-8945-5bff6ae782c2"),
                            ParentId = 0,
                            SortOrder = 1,
                            Title = "General"
                        },
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("615fa84d-fe96-4862-b27c-fe284ad4e932"),
                            ParentId = 0,
                            SortOrder = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Enabled = true,
                            Guid = new Guid("66d7030e-324e-4a16-8b88-9e43841620e9"),
                        ...
                        new
                        {
                            Id = 4,
                            Enabled = true,
                            Guid = new Guid("11f1c1f9-5777-453e-b933-93dd695d444f"),
                        ...
                        new
                        {
                            Id = 5,
                            Enabled = true,
                            Guid = new Guid("1f844ee4-78ed-4aed-91a9-386961eda886"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 6,
                            Enabled = true,
                            Guid = new Guid("1fd7ee53-63fc-4fa1-9a1a-2426dd002f05"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 7,
                            Enabled = true,
                            Guid = new Guid("bbd143e0-36a3-4dce-985e-859d4df1c443"),
                        ...
                        new
                        {
                            Id = 8,
                            Enabled = true,
                            Guid = new Guid("cf51c709-308e-4c56-b5c5-c4569478379f"),
                        ...
                        new
                        {
                            Id = 9,
                            Enabled = true,
                            Guid = new Guid("d8246e28-b50c-48c3-9226-eae0e4bf01b0"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 2,
            ...
            modelBuilder.Entity("Generic.Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("eca3107c-ffa9-4cee-8e54-462f0a9e98e8"),
                        ...
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("31813cef-d1d0-4c2a-a51e-199d0d2b9347"),
