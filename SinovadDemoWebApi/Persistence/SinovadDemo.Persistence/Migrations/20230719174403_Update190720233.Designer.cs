...
namespace SinovadDemo.Persistence.Migrations
{
    ...
    [Migration("20230719174403_Update190720233")]
    partial class Update190720233
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Generic.Core.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = false,
                            Guid = new Guid("25d3c9f3-d205-48b0-b36f-93f46435ec57"),
                            ParentId = 0,
                            SortOrder = 1,
                            Title = "Media"
                        },
                        new
                        {
                            Id = 2,
                            Enabled = false,
                            Guid = new Guid("bfdf19e0-777f-49e7-8197-d7f6562c156b"),
                            ParentId = 0,
                            SortOrder = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Enabled = false,
                            Guid = new Guid("1e5c7abd-39c1-41d0-a2c1-e89653d41cf8"),
                            ParentId = 0,
                            SortOrder = 3,
                            Title = "Mantenimiento"
                        },
                        new
                        {
                            Id = 4,
                            Enabled = true,
                            Guid = new Guid("7886f331-b41b-4556-9c3f-9d9b70d8f090"),
                        ...
                        new
                        {
                            Id = 5,
                            Enabled = true,
                            Guid = new Guid("52699d41-6993-4b47-87ba-2aa23299f5df"),
                        ...
                        new
                        {
                            Id = 6,
                            Enabled = true,
                            Guid = new Guid("2df70803-eaeb-4af4-b51e-46a975b44088"),
                        ...
                        new
                        {
                            Id = 7,
                            Enabled = true,
                            Guid = new Guid("17035891-3cfb-4c18-a76c-73dd45bd75be"),
                        ...
                        new
                        {
                            Id = 8,
                            Enabled = true,
                            Guid = new Guid("97c841ac-4646-4f2a-ab98-8a3bf15c0397"),
                            IconClass = "fa-solid fa-database",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 2,
                        ...
                        new
                        {
                            Id = 9,
                            Enabled = true,
                            Guid = new Guid("bef624f9-502f-41a7-a745-62318f01b111"),
                            IconClass = "fa-solid fa-film",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 3,
                        ...
                        new
                        {
                            Id = 10,
                            Enabled = true,
                            Guid = new Guid("0c31e93c-ad43-4843-bc9a-575eea258123"),
                            IconClass = "fa-solid fa-tv",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 3,
                        ...
                        new
                        {
                            Id = 11,
                            Enabled = true,
                            Guid = new Guid("55bde8d5-dbfe-462e-95a0-846b97cc12c1"),
                        ...
                        new
                        {
                            Id = 12,
                            Enabled = true,
                            Guid = new Guid("41cee951-fcb6-4096-b4ed-42a0a806a696"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 3,
                        ...
                        new
                        {
                            Id = 13,
                            Enabled = true,
                            Guid = new Guid("cd1c8388-0848-4c71-850a-c4b58be5daf3"),
                        ...
                        new
                        {
                            Id = 14,
                            Enabled = true,
                            Guid = new Guid("8ad27c40-3373-4f5c-8572-9f95a105dc56"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 3,
            ...
            modelBuilder.Entity("Generic.Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("f3e82bc7-5230-4e4a-84d4-166e32021764"),
                            Name = "Administrador"
                        },
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("0e4eb48d-90b3-4bed-8068-d54a921042b7"),
                            Name = "Registrado"
                        });
                });
            ...
            modelBuilder.Entity("SinovadDemo.Domain.Entities.Catalog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Guid = new Guid("fad71ef9-f587-4af3-a3e9-13e15d8e7d60"),
                            Name = "Estado del Servidor Multimedia"
                        },
                        new
                        {
                            Id = 2,
                            Guid = new Guid("dbfabeb8-efe5-43bb-9bfb-5fef586e85de"),
                            Name = "Tipos de contenido Multimedia "
                        },
                        new
                        {
                            Id = 3,
                            Guid = new Guid("bf1634ac-0b8b-4684-b576-6284408e64fe"),
                            Name = "Tipos de transmisión de Video"
                        },
                        new
                        {
                            Id = 4,
                            Guid = new Guid("1e525b2e-982d-43a3-86dd-e58727fbe103"),
                            Name = "Preajuste del transcodificador"
                        },
                        new
                        {
                            Id = 5,
                            Guid = new Guid("4be865c8-f0be-4652-abbb-6e32b43e0e8f"),
                            Name = "Tipo de Icono"
                        });
                });
            ...
            modelBuilder.Entity("SinovadDemo.Domain.Entities.CatalogDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CatalogId = 1,
                            Id = 1,
                            Guid = new Guid("785b62e7-3045-4fce-b5cf-35fe95b9c267"),
                            Name = "Iniciado"
                        },
                        new
                        {
                            CatalogId = 1,
                            Id = 2,
                            Guid = new Guid("c38961a4-d23e-49be-bf09-0b9f2605c95e"),
                            Name = "Pausado"
                        },
                        new
                        {
                            CatalogId = 2,
                            Id = 1,
                            Guid = new Guid("8bec5265-2be7-446d-91a6-a2b6cec42923"),
                            Name = "Película"
                        },
                        new
                        {
                            CatalogId = 2,
                            Id = 2,
                            Guid = new Guid("4f5393b0-314a-4c02-a294-2c4401c0205c"),
                            Name = "Serie de TV"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 1,
                            Guid = new Guid("483eb51d-1b7c-421a-931b-e59e111cadf3"),
                            Name = "Normal"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 2,
                            Guid = new Guid("0dc8151e-f94a-42ba-8a28-fda5db12212a"),
                            Name = "MPEG-DASH"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 3,
                            Guid = new Guid("fb718431-aa2b-44c1-9d6f-96cf50b06552"),
                            Name = "HLS"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 1,
                            Guid = new Guid("cf054f37-cb44-45cf-8728-da02d25065ec"),
                            Name = "ultrafast",
                            TextValue = "ultrafast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 2,
                            Guid = new Guid("75cee602-820b-4237-9f87-4fd60d0886db"),
                            Name = "superfast",
                            TextValue = "superfast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 3,
                            Guid = new Guid("f74ca75b-21a9-4e09-8c7f-bbb0c0cdb7c5"),
                            Name = "veryfast",
                            TextValue = "veryfast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 4,
                            Guid = new Guid("29d02f96-6a7f-45b0-ab12-f9cd7dac0bec"),
                            Name = "faster",
                            TextValue = "faster"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 5,
                            Guid = new Guid("e73fa192-104f-4e4f-83f9-69e36ac44e41"),
                            Name = "fast",
                            TextValue = "fast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 6,
                            Guid = new Guid("8081d93f-60f0-4521-8699-0a4285d5861c"),
                            Name = "medium",
                            TextValue = "medium"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 7,
                            Guid = new Guid("4b2bedb4-a2b7-4e14-9c88-2565cf7b12f4"),
                            Name = "slow",
                            TextValue = "slow"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 8,
                            Guid = new Guid("a1bc31b4-5dbc-4e81-ab51-d0dc3dbf700d"),
                            Name = "slower",
                            TextValue = "slower"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 9,
                            Guid = new Guid("aabc6c40-f36b-432b-bd90-907657c3a419"),
                            Name = "veryslow",
                            TextValue = "veryslow"
                        },
                        new
                        {
                            CatalogId = 5,
                            Id = 1,
                            Guid = new Guid("40c49a76-5f11-4c50-8477-64ca33d7e79a"),
                            Name = "Imagen"
                        },
                        new
                        {
                            CatalogId = 5,
                            Id = 2,
                            Guid = new Guid("546e2ef7-679d-40df-b23d-771068763fc1"),
                            Name = "Font Awesome"
                        });
                });
