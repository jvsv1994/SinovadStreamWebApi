...
namespace SinovadDemo.Persistence.Migrations
{
    ...
    [Migration("20230921192543_210920234")]
    partial class _210920234
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Generic.Core.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("1ac9f316-ee9b-4cec-a8b6-24cb0d9c7d83"),
                            ParentId = 0,
                            SortOrder = 1,
                            Title = "General"
                        },
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("74c145b0-7467-4603-a3f5-6c61a07e2003"),
                            ParentId = 0,
                            SortOrder = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Enabled = true,
                            Guid = new Guid("c8bf90b7-d53e-45e0-bcc7-ebea358a1869"),
                        ...
                        new
                        {
                            Id = 4,
                            Enabled = true,
                            Guid = new Guid("1391b529-c617-4326-8ffd-c2f8e2fbe7e8"),
                        ...
                        new
                        {
                            Id = 5,
                            Enabled = true,
                            Guid = new Guid("a03f868c-d336-4303-87ad-004eb61486df"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 6,
                            Enabled = true,
                            Guid = new Guid("35f03671-bcb7-4717-9b23-28facd5a6392"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 1,
                        ...
                        new
                        {
                            Id = 7,
                            Enabled = true,
                            Guid = new Guid("dead4d3a-fa03-4f1f-9788-77d0ca4042b8"),
                        ...
                        new
                        {
                            Id = 8,
                            Enabled = true,
                            Guid = new Guid("532049ac-529c-4005-b721-e1da0a692898"),
                        ...
                        new
                        {
                            Id = 9,
                            Enabled = true,
                            Guid = new Guid("fb11172c-a222-4af7-adbd-706a9508d977"),
                            IconClass = "fa-solid fa-list-check",
                            IconTypeCatalogDetailId = 2,
                            IconTypeCatalogId = 5,
                            ParentId = 2,
            ...
            modelBuilder.Entity("Generic.Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Enabled = true,
                            Guid = new Guid("eb0d99d8-f99c-4d9a-abdb-75a0261ee8fb"),
                        ...
                        new
                        {
                            Id = 2,
                            Enabled = true,
                            Guid = new Guid("52f1d7a1-2a85-4c08-a4cc-bb566bd26d61"),
            ...
            modelBuilder.Entity("SinovadDemo.Domain.Entities.Catalog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Guid = new Guid("d46fbdb0-8f00-41e9-845a-4bad409c5e97"),
                            Name = "Estado del Servidor Multimedia"
                        },
                        new
                        {
                            Id = 2,
                            Guid = new Guid("a4100363-0275-41d7-8a97-c4a1a87e829a"),
                            Name = "Tipos de contenido Multimedia "
                        },
                        new
                        {
                            Id = 3,
                            Guid = new Guid("e109c06d-7fb1-448c-a714-088d80ef0b06"),
                            Name = "Tipos de transmisión de Video"
                        },
                        new
                        {
                            Id = 4,
                            Guid = new Guid("c905c2b6-e5fe-428d-81a8-bae54cbfbef9"),
                            Name = "Preajuste del transcodificador"
                        },
                        new
                        {
                            Id = 5,
                            Guid = new Guid("7236395a-80d8-45d9-b3f7-4fdb734e8fd7"),
                            Name = "Tipo de Icono"
                        },
                        new
                        {
                            Id = 6,
                            Guid = new Guid("69778b46-afa9-4042-aae2-90e376a9affc"),
            ...
            modelBuilder.Entity("SinovadDemo.Domain.Entities.CatalogDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CatalogId = 1,
                            Id = 1,
                            Guid = new Guid("3fc804e7-29d6-413a-9c78-e4bce624672a"),
                            Name = "Iniciado"
                        },
                        new
                        {
                            CatalogId = 1,
                            Id = 2,
                            Guid = new Guid("d828371b-a1ff-4c53-a093-5b0daa2a3dce"),
                            Name = "Pausado"
                        },
                        new
                        {
                            CatalogId = 2,
                            Id = 1,
                            Guid = new Guid("d8c62b10-796b-49d2-828f-f52b95fd372d"),
                            Name = "Película"
                        },
                        new
                        {
                            CatalogId = 2,
                            Id = 2,
                            Guid = new Guid("470bbe9c-1d95-4334-8fff-416a8fcce1fc"),
                            Name = "Serie de TV"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 1,
                            Guid = new Guid("88ae4a65-5e55-40c8-86fd-1023735e31b3"),
                            Name = "Normal"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 2,
                            Guid = new Guid("7aa7c0fe-651d-4eae-b9bb-c3000de781d4"),
                            Name = "MPEG-DASH"
                        },
                        new
                        {
                            CatalogId = 3,
                            Id = 3,
                            Guid = new Guid("2c85db02-f550-4f84-bd60-cd24cc145a37"),
                            Name = "HLS"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 1,
                            Guid = new Guid("4e277b6a-15f4-4a73-a1b1-08a1c779d39e"),
                            Name = "ultrafast",
                            TextValue = "ultrafast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 2,
                            Guid = new Guid("efe6f359-5613-448f-9a1f-ba0d189a1f8d"),
                            Name = "superfast",
                            TextValue = "superfast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 3,
                            Guid = new Guid("ae50b522-bca3-4132-9753-3e29126f9a6b"),
                            Name = "veryfast",
                            TextValue = "veryfast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 4,
                            Guid = new Guid("40e7dc08-c4af-4314-a07b-8c23c4424b66"),
                            Name = "faster",
                            TextValue = "faster"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 5,
                            Guid = new Guid("8b3c3e3a-9ca1-499d-8910-5ad52aa23d99"),
                            Name = "fast",
                            TextValue = "fast"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 6,
                            Guid = new Guid("0b9b4ecd-a521-4874-83c4-ad463f39265d"),
                            Name = "medium",
                            TextValue = "medium"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 7,
                            Guid = new Guid("2d644e0e-0b8f-4bc3-a488-6beb2b5c7633"),
                            Name = "slow",
                            TextValue = "slow"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 8,
                            Guid = new Guid("ab7f6722-51b6-4b07-9cca-6b8038cb5bc6"),
                            Name = "slower",
                            TextValue = "slower"
                        },
                        new
                        {
                            CatalogId = 4,
                            Id = 9,
                            Guid = new Guid("a87293df-8f0e-4760-898e-3df32b6fc449"),
                            Name = "veryslow",
                            TextValue = "veryslow"
                        },
                        new
                        {
                            CatalogId = 5,
                            Id = 1,
                            Guid = new Guid("d108bbb3-178e-4bbf-b295-1fedde1d766e"),
                            Name = "Imagen"
                        },
                        new
                        {
                            CatalogId = 5,
                            Id = 2,
                            Guid = new Guid("e2f02432-b7bd-4c8a-b378-52baa5af22cd"),
                            Name = "Font Awesome"
                        },
                        new
                        {
                            CatalogId = 6,
                            Id = 1,
                            Guid = new Guid("c44f450e-9c94-4ee6-b546-82f3a688ba43"),
                            Name = "Google"
                        },
                        new
                        {
                            CatalogId = 6,
                            Id = 2,
                            Guid = new Guid("d5992ab1-9cae-4c45-a191-5e01bc5b055f"),
                            Name = "Facebook"
                        },
                        new
                        {
                            CatalogId = 6,
                            Id = 3,
                            Guid = new Guid("452fb444-609b-4b87-99b9-a567528cc137"),
                            Name = "Apple"
                        });
                });
